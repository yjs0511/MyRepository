...
<html>
	...
	<body>
		...
		3. <a href="03_global_local_valuables.jsp">지역 변수와 전역 변수</a><br/>
		4. <a href="04_string_method.jsp">String 객체의 메소드</a><br/>
		5. <a href="05_string_to_number.jsp">String을 숫자로 변환</a><br/>
		6. <a href="06_math_method">수학 관련 메소드</a><br/>
		7. <a href="07_data.jsp">날짜 얻기</a><br/>
		...
		13. <a href="13_validation.jsp">유효성 검사 (입력 값 검사)</a><br/>
